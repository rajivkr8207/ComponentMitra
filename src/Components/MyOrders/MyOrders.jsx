                            ...
                            >
                                ...
                                <div className="flex-1 lg:w-[50%] w-[62%] flex flex-col justify-between">
                                    <div className="text-left">
                                        <h2 className="lg:text-lg text-sm font-semibold">{order.productName}</h2>
                                        <p className="lg:text-lg text-base font-semibold text-gray-800">{order.amount}</p>
                                        <p className="text-gray-600 lg:text-lg text-sm">
                                            Order Date: <span className="text-gray-500">{order.orderDate}</span>
                                        </p>
                                ...
                                <div className="lg:w-[40%] w-[18%] flex flex-row items-center justify-between lg:gap-6">
                                    ...
                                    <div className="lg:flex hidden items-center gap-2 ">
                                        <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                                        <p className="text-gray-500 lg:text-lg text-sm">{order.status}</p>
                                    </div>
