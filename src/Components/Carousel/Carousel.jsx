      ...
      <div className="slider-container">
        <Slider {...settings}>
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 w-full h-full p-6 bg-gradient-to-t from-black to-white/10 bg-opacity-50 text-white text-center">
              <div className='w-full absolute bottom-0 left-[50%] translate-x-[-50%] py-3'>
                <h2 className="lg:text-3xl text-xl font-bold mb-4">Explore Our New Collection</h2>
                <p className="mb-4">Discover the latest trends and styles.</p>
                <button className="bg-[--primary-color] hover:bg-[--secondary-color] text-white py-2 lg:px-6 px-3 rounded">Shop Now</button>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 w-full h-full p-6 bg-gradient-to-t from-black to-white/10 bg-opacity-50 text-white text-center">
              <div className='w-full absolute bottom-0 left-[50%] translate-x-[-50%] py-3'>
                <h2 className="lg:text-3xl text-xl font-bold mb-4">Seasonal Sale</h2>
